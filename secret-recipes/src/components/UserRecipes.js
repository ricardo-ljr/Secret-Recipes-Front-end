    ...
    return (
        <div>
            <form>
                ...
                <Select labelId='author-label' id='author' name='author' value={author} onChange={handleChange}>
                    {authorList.map(author => {
                        return <MenuItem value={author}>{author}</MenuItem>
                    })}
                </Select>
                <Button type='submit' variant='contained' color='primary' onClick={handleSubmit}>Get Recipes</Button>
            </form>
